...
Home: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-spanner

Package license: Apache-2.0

Summary: Google Cloud Spanner API client library

Development: https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-spanner
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-cloud-spanner-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-cloud-spanner-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-cloud-spanner
# for installing globally
pixi global install google-cloud-spanner
```
...
It is possible to list all of the versions of `google-cloud-spanner` available on your platform:
...
```
pixi search google-cloud-spanner --channel conda-forge
```
